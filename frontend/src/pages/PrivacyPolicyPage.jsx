    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-28 md:px-6">
        ...
        <div className="space-y-6 rounded-[2rem] border border-white/10 bg-slate-900/70 p-8 text-slate-300">
          <section>
            <h3 className="text-2xl font-semibold text-white">Data Collection</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-white">Data Usage</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-white">Cookies and Analytics</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-white">Third-party Services</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-white">User Rights</h3>
