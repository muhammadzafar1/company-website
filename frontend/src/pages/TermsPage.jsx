    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-28 md:px-6">
        ...
        <div className="space-y-6 rounded-[2rem] border border-[var(--border)] bg-[var(--dark-surface)] p-8 text-[var(--text-onDarkMuted)]">
          <section>
            <h3 className="text-2xl font-semibold text-[var(--text-onDark)]">Terms of Use</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-[var(--text-onDark)]">Intellectual Property</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-[var(--text-onDark)]">Service Agreements</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-[var(--text-onDark)]">Limitation of Liability</h3>
          ...
          <section>
            <h3 className="text-2xl font-semibold text-[var(--text-onDark)]">Termination</h3>
